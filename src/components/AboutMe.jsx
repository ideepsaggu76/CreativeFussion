...
const AboutMe = () => {
  ...
  // Preload profile image when component mounts
  useEffect(() => {
    const img = new Image();
    ...
    preloadLink.href = PROFILE_IMAGE_PATH;
        ...
        <div className="flex flex-col items-center mb-12">
          ...
          >
            <div className={`relative w-full h-full mx-auto overflow-hidden rounded-full shadow-lg border-4 ${
              ...
              <div className={`w-full h-full ${isDarkMode ? 'bg-gray-900' : 'bg-gray-100'} transition-all duration-300`}>
                <ImageWithFallback 
                  src={PROFILE_IMAGE_PATH}
                  alt="Randeep Singh" 
                  className={`w-full h-full object-contain transition-opacity duration-300 ${imageLoaded ? 'opacity-100' : 'opacity-0'}`}
                  fallbackIcon={<FaUser className="text-white" size={50} />}
            ...
            >
              ...
              <div className="flex items-center justify-center h-[80vh] bg-transparent">
                <ImageWithFallback 
                  ...
                  fallbackIcon={<FaUser className="text-white" size={120} />}
                  fallbackColor="#22c55e"
                  style={{
