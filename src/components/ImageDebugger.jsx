...
const ImageDebugger = () => {
  const [testImages, setTestImages] = useState([
    { id: 1, path: "/images/services/logo-design.jpg", loaded: false, error: null },
    { id: 2, path: "/images/services/visiting-card.jpg", loaded: false, error: null },
    { id: 3, path: "/images/services/data-entry.jpg", loaded: false, error: null },
    { id: 4, path: "/images/services/social-media.jpg", loaded: false, error: null },
    { id: 5, path: "/images/logo.svg", loaded: false, error: null }
  ]);
